...
class MysqlModel {
    ...
    public function where($field, $opt = null, $value = null) {
        ...
        if ($field instanceof \Closure) {
            ...
            $this->sqlBuilder->addWhere($field[0], $field[1], $field[2], 'AND');
        } else {
    ...
    public function whereArr($array) {
        foreach ($array as $value) {
            $this->sqlBuilder->addWhere($value[0], $value[1], $value[2], 'AND');
        }
        return $this;
    }
    ...
    public function whereOr($field, $opt = null, $value = null) {
        if ($field instanceof \Closure) {
            ...
            $this->sqlBuilder->addWhere($field[0], $field[1], $field[2], 'OR');
        } else {
